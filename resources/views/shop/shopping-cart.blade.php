        ...
        <div class="row"> <div class="col6">
                ...
                <table  class="table">
                    ...
                    @foreach($products as $product)
                        <tr>
                            <td class="list-item">
                                <a href="{{route('home.show',$product['item']['id'])}}"><img class="imagenessugeridas centrar" src="{{secure_asset('storage/'.$product['item']['foto'])}}" alt="Foto mueble con el nombre: {{$product['item']['nombre_producto']}}"/> </a>
                            </td>
